...
class WebSecurityConfig : WebSecurityConfigurerAdapter() {
    ...
    override fun configure(http: HttpSecurity) {
        http
                ...
                .permitAll()
                .antMatchers(HttpMethod.GET, "/player/**", "/team/**", "/competition/**")
                .permitAll()
                .antMatchers(HttpMethod.POST, "/team/**")
                .hasRole(RoleName.ROLE_ADMIN.value)
                .antMatchers(HttpMethod.PUT, "/player/**", "/team/**", "/competition/**")
                .hasRole(RoleName.ROLE_ADMIN.value)
                .antMatchers(HttpMethod.DELETE, "/player/**", "/team/**", "/competition/**")
                .hasRole(RoleName.ROLE_ADMIN.value)
                .anyRequest()
                .authenticated()
