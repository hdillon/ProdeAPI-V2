...
class WebSecurityConfig : WebSecurityConfigurerAdapter() {
    ...
    override fun configure(http: HttpSecurity) {
        http
                ...
                .permitAll()
                .antMatchers(HttpMethod.GET, "/player/**", "/team/**", "/competition/**", "/prode/**")
                .permitAll()
                .antMatchers(HttpMethod.POST, "/team/**")
                .hasRole(RoleName.ROLE_ADMIN.value)
                .antMatchers(HttpMethod.PUT, "/player/**", "/team/**", "/competition/**", "/prode/**")
                .hasRole(RoleName.ROLE_ADMIN.value)
                .antMatchers(HttpMethod.DELETE, "/player/**", "/team/**", "/competition/**", "/prode/**")
                .hasRole(RoleName.ROLE_ADMIN.value)
                .anyRequest()
                .authenticated()
